const comment = {
  ...
  function settingUp(){
    ...
    section_container.innerHTML = getForm(comment.comments[0].score,comment.comments[0].username,comment.comments[0].createdAt,comment.comments[0].content);
  ...
  function getForm(object_score,Names,period,content){
